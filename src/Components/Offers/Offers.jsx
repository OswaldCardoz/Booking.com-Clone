        ...
        <div className='offerCard-container'>
            ...
            <div className='offer-card'>
                <article className='offer-card-details'>
                    ...
                    <button className='same-btn' id='flight-btn' onClick={() => navigate('/')}>Find a stay</button>
                </article>
            ...
            <div className='offer-card'>
                <article className='offer-card-details'>
                    ...
                    <button className='same-btn' id='flight-btn' onClick={() => navigate('/flights')}>Search for flights</button>
                </article>

                <div className='offer-img-div'>
                    <img src="https://r-xx.bstatic.com/xdata/images/xphoto/500x500/184698944.png?k=6bb1bf3c13db4a7ba3c22a2d1f1051f793c525a78104703b4dec3eb12101f545&o=" width='100%' height='100%' alt="" />
                </div>
            </div>
